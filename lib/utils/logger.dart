...
class MyLogger {
  ...
  void s(dynamic message, {StackTrace? stackTrace}) {
    _print("💚️ SEND: $message", stackTrace: stackTrace);
  }

  /// Log a message at level debug.
  void r(dynamic message, {StackTrace? stackTrace}) {
    _print("💙 DATA: $message", stackTrace: stackTrace);
  }
